...
class CRM_Core_BAO_CustomField extends CRM_Core_DAO_CustomField {
   ...
   * @throws \Exception
   */
  public static function displayValue($value, $field, $contactId = NULL, $fileId = NULL) {
    ...
    return self::formatDisplayValue($value, $fieldInfo, $contactId, $fileId);
  }
   ...
   * @return string
   */
  private static function formatDisplayValue($value, $field, $entityId = NULL, $fileId = NULL) {
